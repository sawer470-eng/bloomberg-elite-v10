...
def render_insider_data():
    st.markdown("<h2 style='color: #FF9900; font-family: Outfit, sans-serif; border-bottom: 2px solid rgba(255, 153, 0, 0.4); padding-bottom:10px; text-transform: uppercase; letter-spacing: 1px;'>[INSIDER TRADING TRACKER: ELITE V3]</h2>", unsafe_allow_html=True)
        ...
        try:
            ...
            if df is None or df.empty:
                ...
                <div class="metric-card" style="border-left: 4px solid #FF9900;">
                    <h4 style="color:#FF9900; margin:0;">[DATA UNAVAILABLE]</h4>
                    <p style="color:#8b949e; margin:5px 0 0 0;">Yahoo Finance SEC scraping is currently rate-limited on Streamlit Cloud. 
                    Institutional transactions for {ticker} will reappear once the API limit resets.</p>
                </div>
